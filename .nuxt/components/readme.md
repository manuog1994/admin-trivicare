...
- `<DashboardSales>` | `<dashboard-sales>` (components/dashboard/Sales.vue)
- `<DashboardVisitPagesCounter>` | `<dashboard-visit-pages-counter>` (components/dashboard/VisitPagesCounter.vue)
