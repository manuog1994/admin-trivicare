...
import * as cookieUniversal from 'cookie-universal';
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(fontawesomeSvgCore);
...
const require$$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(jwtDecode);

const require$$4 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(destr);

const require$$5 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(freeBrandsSvgIcons);

const require$$6 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(requrl);

const require$$7 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(cookie);

const require$$8 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(url);
...
const require$$12 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(cookieUniversal);

const require$$13 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(swiper);
...
const require$$30 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(deepmerge);

const require$$31 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(merge);

const require$$32 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(es_typedArray_set);

const require$$33 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(jsFileDownload);

const require$$34 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(sweetalert2);

const require$$35 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(imageMeta);
...
(function (module) {
	module.exports = function(modules) {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    var _vue_runtime_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    (function(URLSearchParams) {
	      ...
	      function parseURL(input = "", defaultProto) {
	        ...
	        return { protocol, auth: auth ? auth.substr(0, auth.length - 1) : "", host, pathname, search, hash };
	      }
	      ...
	      function parseHost(input = "") {
	        ...
	        return { hostname: decode(hostname), port };
	      }
	    ...
	    }).call(this, __webpack_require__(19)["URLSearchParams"]);
	  },
	  function(module2, __webpack_exports__, __webpack_require__) {
	    __webpack_require__.d(__webpack_exports__, "a", function() {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    var _dist_vuex_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    const middleware = {};
	    middleware["admin"] = __webpack_require__(49);
	  ...
	  function(module2, exports, __webpack_require__) {
	     ...
	     */
	    var index = { name: "NoSsr", functional: true, props: { placeholder: String, placeholderTag: { type: String, default: "div" } }, render: function render(h, ref) {
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    function makeLocalContext(store, namespace, path) {
	      ...
	      var local = { dispatch: noNamespace ? store.dispatch : function(_type, _payload, _options) {
	      ...
	      Object.defineProperties(local, { getters: { get: noNamespace ? function() {
	    ...
	    function makeLocalGetters(store, namespace) {
	      if (!store._makeLocalGettersCache[namespace]) {
	        ...
	        Object.keys(store.getters).forEach(function(type) {
	          ...
	          Object.defineProperty(gettersProxy, localType, { get: function() {
	    ...
	    function registerAction(store, type, handler, local) {
	      ...
	      entry.push(function wrappedActionHandler(payload) {
	        var res = handler.call(store, { dispatch: local.dispatch, commit: local.commit, getters: local.getters, state: local.state, rootGetters: store.getters, rootState: store.state }, payload);
	        if (!isPromise(res)) {
	    ...
	    var createNamespacedHelpers = function(namespace) {
	      return { mapState: mapState.bind(null, namespace), mapGetters: mapGetters.bind(null, namespace), mapMutations: mapMutations.bind(null, namespace), mapActions: mapActions.bind(null, namespace) };
	    };
	    ...
	    var index_cjs = { Store, install, version: "3.6.2", mapState, mapMutations, mapGetters, mapActions, createNamespacedHelpers, createLogger };
	  ...
	  function(module2, exports, __webpack_require__) {
	     ...
	     * Released under the MIT License.
	     */
	    var index = { name: "ClientOnly", functional: true, props: { placeholder: String, placeholderTag: { type: String, default: "div" } }, render: function render(h, ref) {
	      var parent = ref.parent;
	      var slots = ref.slots;
	      var props = ref.props;
	      var ref$1 = slots();
	      ...
	      if (props.placeholderTag && (props.placeholder || placeholderSlot)) {
	        return h(props.placeholderTag, { class: ["client-only-placeholder"] }, props.placeholder || placeholderSlot);
	      }
	      return defaultSlot.length > 0 ? defaultSlot.map(function() {
	        return h(false);
	      }) : h(false);
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    var defaultInfo = { title: void 0, titleChunk: "", titleTemplate: "%s", htmlAttrs: {}, bodyAttrs: {}, headAttrs: {}, base: [], link: [], meta: [], style: [], script: [], noscript: [], __dangerouslyDisableSanitizers: [], __dangerouslyDisableSanitizersByTagID: {} };
	    ...
	    var defaultOptions = { keyName, attribute, ssrAttribute, tagIDKeyName, contentKeyName, metaTemplateKeyName, waitOnDestroyed, debounceWait, ssrAppId };
	    ...
	    function createMixin(Vue, options) {
	      ...
	      return { beforeCreate: function beforeCreate() {
	        ...
	        Object.defineProperty(this, "_hasMetaInfo", { configurable: true, get: function get() {
	    ...
	    function escapeMetaInfo(options, info, escapeSequences) {
	      ...
	      var escapeOptions = { doEscape: function doEscape(value) {
	    ...
	    function _arrayMerge(_ref, target, source) {
	      ...
	      target.forEach(function(targetItem, targetIndex) {
	        ...
	        if (!sourceTemplate) {
	          applyTemplate({ component, metaTemplateKeyName: metaTemplateKeyName2, contentKeyName: contentKeyName2 }, sourceItem, targetTemplate);
	          sourceItem.template = true;
	          return;
	        }
	        if (!sourceItem[contentKeyName2]) {
	          applyTemplate({ component, metaTemplateKeyName: metaTemplateKeyName2, contentKeyName: contentKeyName2 }, sourceItem, void 0, targetItem[contentKeyName2]);
	        }
	      });
	    ...
	    function merge(target, source, options) {
	      ...
	      return deepmerge(target, source, { arrayMerge: function arrayMerge(t, s) {
	    ...
	    function updateTag(appId2, options, type, tags, head, body) {
	      ...
	      var newElements = [];
	      var queryOptions = { appId: appId2, attribute: attribute2, type, tagIDKeyName: tagIDKeyName2 };
	      var currentElements = { head: queryElements(head, queryOptions), pbody: queryElements(body, queryOptions, { pbody: true }), body: queryElements(body, queryOptions, { body: true }) };
	      if (tags.length > 1) {
	        var found = [];
	      ...
	      return { oldTags: oldElements, newTags: newElements };
	    }
	    ...
	    function addApp(rootVm, appId2, options) {
	      return { set: function set(metaInfo) {
	    ...
	    function refresh(rootVm, options) {
	      ...
	      if (tags && isFunction(metaInfo.changed)) {
	        ...
	        tags = { addedTags: tags.tagsAdded, removedTags: tags.tagsRemoved };
	      }
	    ...
	    function generateServerInjector(options, metaInfo, globalInjectOptions) {
	      var serverInjector = { data: metaInfo, extraData: void 0, addInfo: function addInfo(appId2, metaInfo2) {
	        this.extraData = this.extraData || {};
	        this.extraData[appId2] = metaInfo2;
	      }, callInjectors: function callInjectors(opts) {
	        var m = this.injectors;
	        return (opts.body || opts.pbody ? "" : m.title.text(opts)) + m.meta.text(opts) + m.base.text(opts) + m.link.text(opts) + m.style.text(opts) + m.script.text(opts) + m.noscript.text(opts);
	      }, injectors: { head: function head(ln) {
	        return serverInjector.callInjectors(_objectSpread2(_objectSpread2({}, globalInjectOptions), {}, { ln }));
	      }, bodyPrepend: function bodyPrepend(ln) {
	        return serverInjector.callInjectors(_objectSpread2(_objectSpread2({}, globalInjectOptions), {}, { ln, pbody: true }));
	      }, bodyAppend: function bodyAppend(ln) {
	        return serverInjector.callInjectors(_objectSpread2(_objectSpread2({}, globalInjectOptions), {}, { ln, body: true }));
	      } } };
	      var _loop = function _loop2(type2) {
	        if (metaInfoOptionKeys.includes(type2)) {
	          return "continue";
	        }
	        serverInjector.injectors[type2] = { text: function text(injectOptions) {
	          var addSsrAttribute = injectOptions === true;
	          injectOptions = _objectSpread2(_objectSpread2({ addSsrAttribute }, globalInjectOptions), injectOptions);
	          if (type2 === "title") {
	          ...
	          if (serverInjector.extraData) {
	            for (var _appId2 in serverInjector.extraData) {
	              ...
	              var extraStr = tagGenerator(options, type2, _data2, _objectSpread2({ appId: _appId2 }, injectOptions));
	    ...
	    function $meta(options) {
	      options = options || {};
	      var $root = this.$root;
	      return { getOptions: function getOptions$1() {
	    ...
	    var index = { version, install, generate: function generate$1(metaInfo, options) {
	  ...
	  function(module2) {
	    module2.exports = JSON.parse('{"title":"ADMIN TRIVICARE","meta":[{"hid":"charset","charset":"utf-8"},{"hid":"viewport","name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"mobile-web-app-capable","name":"mobile-web-app-capable","content":"yes"},{"hid":"apple-mobile-web-app-title","name":"apple-mobile-web-app-title","content":"ADMIN TRIVICARE"},{"hid":"theme-color","name":"theme-color","content":"#ffffff"},{"hid":"og:type","name":"og:type","property":"og:type","content":"website"},{"hid":"og:title","name":"og:title","property":"og:title","content":"ADMIN TRIVICARE"},{"hid":"og:site_name","name":"og:site_name","property":"og:site_name","content":"ADMIN TRIVICARE"}],"link":[{"hid":"shortcut-icon","rel":"shortcut icon","href":"/_nuxt/icons/icon_64x64.1f8a4c.png"},{"hid":"apple-touch-icon","rel":"apple-touch-icon","href":"/_nuxt/icons/icon_512x512.1f8a4c.png","sizes":"512x512"},{"rel":"manifest","href":"/_nuxt/manifest.b572b5eb.json","hid":"manifest"}],"htmlAttrs":{"lang":"es"}}');
	  },
	  function(module2, exports) {
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    module2.exports = __webpack_require__(69);
	  },
	  function(module2, exports) {
	    ...
	    function provideFunctionalComponents(component, components) {
	      ...
	      component.exports.render = function(h, vm) {
	        return render(h, Object.assign({}, vm, { _c: function(n, a, b) {
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    */
	    ...
	    function Kn(t2, n2, o2) {
	      if (i(n2) && (n2 = n2.options), function(t3, n3) {
	        ...
	        if (e(o3))
	          ...
	          for (const t4 in o3)
	            i2 = o3[t4], c3 = $(t4), r3[c3] = l(i2) ? i2 : { type: i2 };
	        t3.props = r3;
	      }(n2), function(t3, n3) {
	        const o3 = t3.inject;
	        if (!o3)
	    ...
	    const Yn = { enumerable: true, configurable: true, get: A, set: A };
	    ...
	    const Tr = g((t2) => ({ enterClass: `${t2}-enter`, enterToClass: `${t2}-enter-to`, enterActiveClass: `${t2}-enter-active`, leaveClass: `${t2}-leave`, leaveToClass: `${t2}-leave-to`, leaveActiveClass: `${t2}-leave-active` }));
	    ...
	    function Kr(t2, e2) {
	      ...
	      if (o(r2._leaveCb))
	        return;
	      const { css: i2, type: a2, leaveClass: l2, leaveToClass: u2, leaveActiveClass: f2, beforeLeave: d2, leave: h2, afterLeave: m2, leaveCancelled: _2, delayLeave: v2, duration: y2 } = s2, g2 = false !== i2 && !K, b2 = Gr(h2), $2 = p(c(y2) ? y2.leave : y2), w2 = r2._leaveCb = D(() => {
	    ...
	    })({ nodeOps: Ro, modules: [er, or, ur, hr, kr, {}].concat(Xo) });
	    const Xr = { inserted(t2, e2, n2, o2) {
	    ...
	    const as = { name: String, appear: Boolean, css: Boolean, mode: String, type: String, enterClass: String, leaveClass: String, enterToClass: String, leaveToClass: String, enterActiveClass: String, leaveActiveClass: String, appearClass: String, appearActiveClass: String, appearToClass: String, duration: [Number, String, Object] };
	    function ls(t2) {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    __webpack_require__.r(__webpack_exports__);
	    __webpack_exports__["default"] = function({ app, redirect, route }) {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    __webpack_require__.r(__webpack_exports__);
	    var _node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_9_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_12a32de6_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20);
	    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_9_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_12a32de6_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__)
	      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
	        (function(key) {
	          __webpack_require__.d(__webpack_exports__, key, function() {
	            return _node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_9_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_12a32de6_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key];
	          });
	        })(__WEBPACK_IMPORT_KEY__);
	  },
	  function(module2, __webpack_exports__, __webpack_require__) {
	    __webpack_require__.r(__webpack_exports__);
	    var _node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_nuxt_loading_vue_vue_type_style_index_0_id_3b8fd56e_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
	    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_nuxt_loading_vue_vue_type_style_index_0_id_3b8fd56e_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__)
	      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
	        (function(key) {
	          __webpack_require__.d(__webpack_exports__, key, function() {
	            return _node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_2_0_node_modules_vue_loader_lib_index_js_vue_loader_options_nuxt_loading_vue_vue_type_style_index_0_id_3b8fd56e_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__[key];
	          });
	        })(__WEBPACK_IMPORT_KEY__);
	  },
	  function(module2, exports) {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    var vuex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
	    var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
	    var axios__WEBPACK_IMPORTED_MODULE_2___default = /* @__PURE__ */ __webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);
	    vue__WEBPACK_IMPORTED_MODULE_0__["b"].use(vuex__WEBPACK_IMPORTED_MODULE_1__["a"]);
	    const state = () => ({ products: [], categories: [], cart: [], wishlist: [], compare: [], pagination: [], tags: [], cupon: [], guest: [], duration: 0, notifications: [], reserve: "", step2: false, step3: false, step4: false, shippingMethod: "", shippingAmount: 0, pickUpId: 0, paymentMethod: "", userProfileId: "", conditionsStore: false, newsletterStore: false, order_id: "", invoice_paper: false, note: "", newUserAddress: false, buttonLogin: true });
	    const getters = { getProducts(state2) {
	      return state2.products;
	      ...
	      return state2.guest;
	    }, getTokenPayment(state2) {
	      return state2.tokenPayment;
	    }, getPagination(state2) {
	      return state2.pagination;
	    }, getCart: (state2) => {
	      return state2.cart;
	    }, getReserve: (state2) => {
	      return state2.reserve;
	    }, getStep2: (state2) => {
	      return state2.step2;
	    }, getStep3: (state2) => {
	      return state2.step3;
	      ...
	      return state2.step4;
	    }, getShippingMethod: (state2) => {
	      return state2.shippingMethod;
	    }, getShippingAmount: (state2) => {
	      return state2.shippingAmount;
	    }, getPickUpId: (state2) => {
	      return state2.pickUpId;
	    }, getPaymentMethod: (state2) => {
	      return state2.paymentMethod;
	    }, getUserProfileId: (state2) => {
	      return state2.userProfileId;
	    }, getConditionsStore: (state2) => {
	      return state2.conditionsStore;
	    }, getNewsletterStore: (state2) => {
	      return state2.newsletterStore;
	    }, getOrderId: (state2) => {
	      return state2.order_id;
	    }, getInvoicePaper: (state2) => {
	      return state2.invoice_paper;
	    }, getNote: (state2) => {
	      return state2.note;
	    }, cartItemCount: (state2) => {
	      return state2.cart.length;
	    }, getWishlist: (state2) => {
	      return state2.wishlist;
	    }, getCompare: (state2) => {
	      return state2.compare;
	    }, getNewUserAddress: (state2) => {
	      return state2.newUserAddress;
	    }, getBizumPage: (state2) => {
	      return state2.bizumPage;
	    }, getPaypalPage: (state2) => {
	      return state2.paypalPage;
	    }, getTransferBankPage: (state2) => {
	      return state2.transferBankPage;
	    }, wishlistItemCount: (state2) => {
	      return state2.wishlist.length;
	    }, compareItemCount: (state2) => {
	      return state2.compare.length;
	    }, notificationsItemCount: (state2) => {
	      return state2.notifications.length;
	    }, getSubTotal: (state2) => {
	      let subTotal = 0;
	      ...
	      if (state2.cupon.id) {
	        total = total - total * (state2.cupon.discount / 100);
	      }
	      return total;
	    } };
	    const mutations = { SET_PRODUCT(state2, product) {
	      state2.products = product;
	    }, SET_CATEGORY(state2, category) {
	      state2.categories = category;
	    }, SET_PAGINATION(state2, pagination) {
	      state2.pagination = pagination;
	    }, SET_TAG(state2, tag) {
	      state2.tags = tag;
	    }, SET_CUPON(state2, cupon) {
	      state2.cupon = cupon;
	    }, SET_GUEST(state2, guest) {
	      state2.guest = guest;
	    }, SET_TOKENPAYMENT(state2, tokenPayment) {
	      state2.tokenPayment = tokenPayment;
	    }, SET_DURATION(state2, duration) {
	      state2.duration = duration;
	    }, SET_ORDER_ID(state2, order_id) {
	      state2.order_id = order_id;
	    }, SET_INVOICE_PAPER(state2, invoice_paper) {
	      state2.invoice_paper = invoice_paper;
	    }, SET_NOTE(state2, note) {
	      state2.note = note;
	    }, SET_NEW_USER_ADDRESS(state2, newUserAddress) {
	      state2.newUserAddress = newUserAddress;
	    }, UPDATE_CART(state2, payload) {
	      const item = state2.cart.find((el) => payload.id === el.id);
	      if (item) {
	        ...
	        state2.cart.push({ ...payload, cartQuantity: payload.cartQuantity, total: price });
	      }
	    }, REFRESH_WISHLIST(state2, payload) {
	      state2.wishlist = [];
	      state2.wishlist.push(...payload);
	    }, REFRESH_CART(state2, products) {
	      state2.cart = [];
	      state2.cart.push(...products);
	    }, UPDATE_GUEST(state2, guest) {
	      const item = state2.guest;
	      if (item) {
	    ...
	    }, SET_RESERVE(state2, reserve) {
	      state2.reserve = reserve;
	    }, SET_STEP2(state2, step2) {
	      state2.step2 = step2;
	    }, SET_STEP3(state2, step3) {
	      state2.step3 = step3;
	    }, SET_STEP4(state2, step4) {
	      state2.step4 = step4;
	    }, SET_SHIPPING_METHOD(state2, shippingMethod) {
	      state2.shippingMethod = shippingMethod;
	    }, SET_SHIPPING_AMOUNT(state2, shippingAmount) {
	      state2.shippingAmount = shippingAmount;
	    }, SET_PICKUP_ID(state2, pickUpId) {
	      state2.pickUpId = pickUpId;
	    }, SET_PAYMENT_METHOD(state2, paymentMethod) {
	      state2.paymentMethod = paymentMethod;
	    }, SET_USER_PROFILE_ID(state2, userProfileId) {
	      state2.userProfileId = userProfileId;
	    }, SET_CONDITIONS_STORE(state2, conditionsStore) {
	      state2.conditionsStore = conditionsStore;
	    }, SET_NEWSLETTER_STORE(state2, newsletterStore) {
	      state2.newsletterStore = newsletterStore;
	    }, SET_BIZUM_PAGE(state2, bizumPage) {
	      state2.bizumPage = bizumPage;
	    }, SET_PAYPAL_PAGE(state2, paypalPage) {
	      state2.paypalPage = paypalPage;
	    }, SET_TRANSFER_BANK_PAGE(state2, transferBankPage) {
	      state2.transferBankPage = transferBankPage;
	    }, REMOVE_PRODUCT_FROM_CART(state2, product) {
	      state2.cart = state2.cart.filter((item) => {
	        return product.id !== item.id;
	      });
	    }, DECREASE_PRODUCT(state2, payload) {
	      const found = state2.cart.find((el) => payload.id === el.id);
	      ...
	      state2.guest = [];
	    }, CLEAR_TOKENPAYMENT(state2) {
	      state2.tokenPayment = null;
	    }, ADD_TO_WISHLIST(state2, product) {
	      const item = state2.wishlist.find((el) => product.id === el.id);
	      if (item) {
	        return;
	      }
	      {
	        state2.wishlist.push(product);
	      }
	    }, REMOVE_PRODUCT_FROM_WISHLIST(state2, product) {
	      state2.wishlist = state2.wishlist.filter((item) => {
	        return product.id !== item.id;
	      });
	    }, ADD_TO_COMPARE(state2, product) {
	      const item = state2.compare.find((el) => product.id === el.id);
	      if (item) {
	        return;
	      }
	      {
	        state2.compare.push(product);
	      }
	    }, REMOVE_FROM_COMPARE(state2, product) {
	      state2.compare = state2.compare.filter((item) => {
	        return product.id !== item.id;
	      });
	    } };
	    const actions = { countdown({ commit }, payload) {
	      ...
	      const { data } = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("https://api.trivicare.com/api/products?perPage=" + perPage + "&page=" + page + "&filter[category_id]=" + category + "&filter[name]=" + search + "&filter[slug]=" + slug + "&filter[status]=" + status + "&sort=" + sort + "&tags=" + tag);
	      context.commit("SET_PRODUCT", data);
	      context.commit("SET_PAGINATION", data.meta);
	    }, async getCategories(context) {
	      const { data } = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("https://api.trivicare.com/api/categories");
	      context.commit("SET_CATEGORY", data.data);
	    }, async getTags(context) {
	      const { data } = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("https://api.trivicare.com/api/tags");
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    var _RenderlessPagination = __webpack_require__(61);
	    var _RenderlessPagination2 = _interopRequireDefault(_RenderlessPagination);
	    function _interopRequireDefault(obj) {
	      return obj && obj.__esModule ? obj : { default: obj };
	    }
	    exports.default = { name: "Pagination", components: { RenderlessPagination: _RenderlessPagination2.default }, provide: function provide() {
	      var _this = this;
	      return { Page: function Page() {
	        return _this.value;
	      ...
	      return h("renderless-pagination", { scopedSlots: { default: function _default(props) {
	        return props.override ? h(props.override, { attrs: { props } }) : (0, _template2.default)(props)(h);
	      } } });
	    }, props: { value: { type: Number, required: true, validator: function validator(val) {
	      return val > 0;
	    } }, records: { type: Number, required: true }, perPage: { type: Number, default: 25 }, options: { type: Object } }, data: function data() {
	    ...
	    module2.exports = function(props) {
	      return function(h) {
	        ...
	        var items = this.pages.map(function(page) {
	          return h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + this.activeClass(page), on: { "click": this.setPage.bind(this, page) } }, [h("a", { "class": theme.link + " " + this.activeClass(page), attrs: { role: "button" } }, [this.formatNumber(page)])]);
	        }.bind(this));
	        if (this.opts.edgeNavigation && this.totalChunks > 1) {
	          firstPage = h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + (this.page === 1 ? theme.disabled : "") + " VuePagination__pagination-item-first-page", on: { "click": this.setPage.bind(this, 1) } }, [h("a", { "class": theme.link, attrs: { disabled: this.page === 1 } }, [this.opts.texts.first])]);
	          lastPage = h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + (this.page === this.totalPages ? theme.disabled : "") + " VuePagination__pagination-item-last-page", on: { "click": this.setPage.bind(this, this.totalPages) } }, [h("a", { "class": theme.link, attrs: { disabled: this.page === this.totalPages } }, [this.opts.texts.last])]);
	        }
	        if (this.opts.chunksNavigation === "fixed") {
	          prevChunk = h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + theme.prev + " VuePagination__pagination-item-prev-chunk " + this.allowedChunkClass(-1), on: { "click": this.setChunk.bind(this, -1) } }, [h("a", { "class": theme.link, attrs: { disabled: !!this.allowedChunkClass(-1) } }, [this.opts.texts.prevChunk])]);
	          nextChunk = h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + theme.next + " VuePagination__pagination-item-next-chunk " + this.allowedChunkClass(1), on: { "click": this.setChunk.bind(this, 1) } }, [h("a", { "class": theme.link, attrs: { disabled: !!this.allowedChunkClass(1) } }, [this.opts.texts.nextChunk])]);
	        }
	        return h("div", { "class": "VuePagination " + theme.wrapper }, [h("nav", { "class": "" + theme.nav }, [h("ul", { directives: [{ name: "show", value: this.totalPages > 1 }], "class": theme.list + " VuePagination__pagination" }, [firstPage, prevChunk, h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + theme.prev + " VuePagination__pagination-item-prev-page " + this.allowedPageClass(this.page - 1), on: { "click": this.prev.bind(this) } }, [h("a", { "class": theme.link, attrs: { disabled: !!this.allowedPageClass(this.page - 1) } }, [this.opts.texts.prevPage])]), items, h("li", { "class": "VuePagination__pagination-item " + theme.item + " " + theme.next + " VuePagination__pagination-item-next-page " + this.allowedPageClass(this.page + 1), on: { "click": this.next.bind(this) } }, [h("a", { "class": theme.link, attrs: { disabled: !!this.allowedPageClass(this.page + 1) } }, [this.opts.texts.nextPage])]), nextChunk, lastPage]), h("p", { directives: [{ name: "show", value: parseInt(this.records) }], "class": "VuePagination__count " + theme.count }, [this.count])])]);
	      }.bind(props);
	    };
	  },
	  function(module2, exports, __webpack_require__) {
	    ...
	    exports.default = { inject: ["Page", "records", "perPage"], props: { itemClass: { required: false, default: "VuePagination__pagination-item" } }, render: function render() {
	      var _this = this;
	      return this.$scopedSlots.default({ override: this.opts.template, showPagination: this.totalPages > 1, pages: this.pages, pageEvents: function pageEvents(page) {
	        return { click: function click() {
	      ...
	      }, activeClass: this.activeClass, hasEdgeNav: this.opts.edgeNavigation && this.totalChunks > 1, setPage: this.setPage, setFirstPage: this.setPage.bind(this, 1), setLastPage: this.setPage.bind(this, this.totalPages), hasChunksNav: this.opts.chunksNavigation === "fixed", setPrevChunk: this.prevChunk, setNextChunk: this.nextChunk, setPrevPage: this.prev, firstPageProps: { class: this.Theme.link, disabled: this.page === 1 }, lastPageProps: { class: this.Theme.link, disabled: this.page === this.totalPages }, prevProps: { class: this.Theme.link, disabled: !!this.allowedPageClass(this.page - 1) }, nextProps: { class: this.Theme.link, disabled: !!this.allowedPageClass(this.page + 1) }, pageClasses: function pageClasses(page) {
	      ...
	      var themes = { bootstrap3: __webpack_require__(64), bootstrap4: __webpack_require__(65), bulma: __webpack_require__(66) };
	      if (_typeof(themes[this.opts.theme]) === void 0) {
	    ...
	    } }, methods: { setPage: function setPage(page) {
	  ...
	  function(module2, exports, __webpack_require__) {
	    ...
	    exports.default = function() {
	      return { format: true, chunk: 10, chunksNavigation: "fixed", edgeNavigation: false, theme: "bootstrap3", template: null, texts: { count: "Showing {from} to {to} of {count} records|{count} records|One record", first: "First", last: "Last", nextPage: ">", nextChunk: ">>", prevPage: "<", prevChunk: "<<" } };
	    };
	    module2.exports = exports["default"];
	  },
	  function(module2, exports) {
	  ...
	  function(module2, exports, __webpack_require__) {
	    module2.exports = { nav: "", count: "", wrapper: "", list: "pagination", item: "page-item", link: "page-link", next: "", prev: "", active: "active", disabled: "disabled" };
	  },
	  function(module2, exports, __webpack_require__) {
	    module2.exports = { nav: "", count: "", wrapper: "", list: "pagination", item: "page-item", link: "page-link", next: "", prev: "", active: "active", disabled: "disabled" };
	  },
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    __webpack_require__.d(components_namespaceObject, "Auth", function() {
	      return components_Auth;
	    });
	    __webpack_require__.d(components_namespaceObject, "HeaderWithTopbar", function() {
	      return HeaderWithTopbar;
	    });
	    __webpack_require__.d(components_namespaceObject, "Login", function() {
	      return Login;
	    });
	    __webpack_require__.d(components_namespaceObject, "MobileBar", function() {
	      return MobileBar;
	    });
	    __webpack_require__.d(components_namespaceObject, "MyAccountContainer", function() {
	      return MyAccountContainer;
	    });
	    __webpack_require__.d(components_namespaceObject, "NavBottom", function() {
	      return NavBottom;
	    });
	    __webpack_require__.d(components_namespaceObject, "Navigation", function() {
	      return Navigation;
	    });
	    __webpack_require__.d(components_namespaceObject, "OffCanvasMobileMenu", function() {
	      return OffCanvasMobileMenu;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductDetailsDescriptionReview", function() {
	      return ProductDetailsDescriptionReview;
	    });
	    __webpack_require__.d(components_namespaceObject, "Register", function() {
	      return Register;
	    });
	    __webpack_require__.d(components_namespaceObject, "ResponsiveMobileMenu", function() {
	      return ResponsiveMobileMenu;
	    });
	    __webpack_require__.d(components_namespaceObject, "Search", function() {
	      return Search;
	    });
	    __webpack_require__.d(components_namespaceObject, "TheFooter", function() {
	      return TheFooter;
	    });
	    __webpack_require__.d(components_namespaceObject, "TheHeader", function() {
	      return TheHeader;
	    });
	    __webpack_require__.d(components_namespaceObject, "ClientsGuests", function() {
	      return ClientsGuests;
	    });
	    __webpack_require__.d(components_namespaceObject, "ClientsRegisteds", function() {
	      return ClientsRegisteds;
	    });
	    __webpack_require__.d(components_namespaceObject, "CouponsTable", function() {
	      return CouponsTable;
	    });
	    __webpack_require__.d(components_namespaceObject, "CouponsCreateCoupons", function() {
	      return CouponsCreateCoupons;
	    });
	    __webpack_require__.d(components_namespaceObject, "DashboardAnalyticsGoogle", function() {
	      return DashboardAnalyticsGoogle;
	    });
	    __webpack_require__.d(components_namespaceObject, "DashboardDonutsProducts", function() {
	      return DashboardDonutsProducts;
	    });
	    __webpack_require__.d(components_namespaceObject, "DashboardGraphicMonths", function() {
	      return DashboardGraphicMonths;
	    });
	    __webpack_require__.d(components_namespaceObject, "HeadersNavTop", function() {
	      return HeadersNavTop;
	    });
	    __webpack_require__.d(components_namespaceObject, "HeadersResults", function() {
	      return HeadersResults;
	    });
	    __webpack_require__.d(components_namespaceObject, "HeadersSearch", function() {
	      return HeadersSearch;
	    });
	    __webpack_require__.d(components_namespaceObject, "HeadersSideNav", function() {
	      return HeadersSideNav;
	    });
	    __webpack_require__.d(components_namespaceObject, "InvoicesErrorModal", function() {
	      return InvoicesErrorModal;
	    });
	    __webpack_require__.d(components_namespaceObject, "InvoicesInvoiceViewer", function() {
	      return InvoicesInvoiceViewer;
	    });
	    __webpack_require__.d(components_namespaceObject, "InvoicesTable", function() {
	      return InvoicesTable;
	    });
	    __webpack_require__.d(components_namespaceObject, "InvoicesNewInvoice", function() {
	      return InvoicesNewInvoice;
	    });
	    __webpack_require__.d(components_namespaceObject, "InvoicesSuccessInvoiceModal", function() {
	      return InvoicesSuccessInvoiceModal;
	    });
	    __webpack_require__.d(components_namespaceObject, "LoadersBigLoader", function() {
	      return LoadersBigLoader;
	    });
	    ...
	    __webpack_require__.d(components_namespaceObject, "OrdersNote", function() {
	      return OrdersNote;
	    });
	    __webpack_require__.d(components_namespaceObject, "Orders", function() {
	      return Orders;
	    });
	    __webpack_require__.d(components_namespaceObject, "OrdersCom", function() {
	      return OrdersCom;
	    });
	    __webpack_require__.d(components_namespaceObject, "OrdersHistory", function() {
	      return OrdersHistory;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductCreateProduct", function() {
	      return ProductCreateProduct;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductEditProduct", function() {
	      return ProductEditProduct;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductDetailsWrapper", function() {
	      return ProductDetailsWrapper;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductGridItem", function() {
	      return ProductGridItem;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductGridItemTwo", function() {
	      return ProductGridItemTwo;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductGridStyleThree", function() {
	      return ProductGridStyleThree;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductWrapperCosmetics", function() {
	      return ProductWrapperCosmetics;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProductProductsTable", function() {
	      return ProductProductsTable;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProfileNewGuest", function() {
	      return ProfileNewGuest;
	    });
	    __webpack_require__.d(components_namespaceObject, "ProfileNewProfile", function() {
	      return ProfileNewProfile;
	    });
	    __webpack_require__.d(components_namespaceObject, "ReviewsNewReview", function() {
	      return ReviewsNewReview;
	    });
	    __webpack_require__.d(components_namespaceObject, "ReviewsReviewTable", function() {
	      return ReviewsReviewTable;
	    });
	    var ipx_namespaceObject = {};
	    __webpack_require__.r(ipx_namespaceObject);
	    __webpack_require__.d(ipx_namespaceObject, "getImage", function() {
	      return ipx_getImage;
	    });
	    __webpack_require__.d(ipx_namespaceObject, "validateDomains", function() {
	      return validateDomains;
	    });
	    __webpack_require__.d(ipx_namespaceObject, "supportsAlias", function() {
	      return supportsAlias;
	    });
	    ...
	    var custom_namespaceObject = {};
	    __webpack_require__.r(custom_namespaceObject);
	    __webpack_require__.d(custom_namespaceObject, "getImage", function() {
	      return custom_getImage;
	    });
	    var vue_runtime = __webpack_require__(0);
	    var dist = __webpack_require__(1);
	    var _nuxt_middleware = __webpack_require__(7);
	    ...
	    async function getRouteData(route) {
	      ...
	      return { ...route, meta: getMatchedComponents(route).map((Component, index) => {
	        return { ...Component.options.meta, ...(route.matched[index] || {}).meta };
	      }) };
	    }
	    async function setContext(app, context) {
	      if (!app.context) {
	        app.context = { isStatic: false, isDev: false, isHMR: false, app, store: app.store, payload: context.payload, error: context.error, base: app.router.options.base, env: { "baseUrl": "https://api.trivicare.com", "url": "https://admin.trivicare.com", "URL": "https://admin.trivicare.com", "BASE_URL": "https://api.trivicare.com" } };
	        if (context.req) {
	        ...
	        app.context.redirect = (status, path, query) => {
	          ...
	          if (/(^[.]{1,2}\/)|(^\/(?!\/))/.test(path)) {
	            app.context.next({ path, query, status });
	          } else {
	            path = Object(dist["j"])(path, query);
	            {
	              app.context.next({ path, status });
	            }
	          }
	        };
	        {
	    ...
	    function normalizeError(err) {
	      ...
	      return { ...err, message, statusCode: err.statusCode || err.status || err.response && err.response.status || 500 };
	    }
	    ...
	    function parse(str, options) {
	      ...
	      while ((res = PATH_REGEXP.exec(str)) != null) {
	        ...
	        tokens.push({ name: name || key++, prefix: prefix || "", delimiter, optional, repeat, partial, asterisk: Boolean(asterisk), pattern: pattern ? escapeGroup(pattern) : asterisk ? ".*" : "[^" + escapeString(delimiter) + "]+?" });
	      }
	      if (index < str.length) {
	    ...
	    var fetch_server = { created() {
	      ...
	      vue_runtime["b"].util.defineReactive(this, "$fetchState", { pending: true, error: null, timestamp: Date.now() });
	      addLifecycleHook(this, "serverPrefetch", serverPrefetch);
	    } };
	    var vuex = __webpack_require__(6);
	    var vue_meta_common = __webpack_require__(22);
	    var vue_meta_common_default = /* @__PURE__ */ __webpack_require__.n(vue_meta_common);
	    var vue_client_only_common = __webpack_require__(17);
	    var vue_client_only_common_default = /* @__PURE__ */ __webpack_require__.n(vue_client_only_common);
	    var vue_no_ssr_common = __webpack_require__(12);
	    ...
	    function createRoute(record, location, redirectedFrom, router) {
	      ...
	      var route = { name: location.name || record && record.name, meta: record && record.meta || {}, path: location.path || "/", hash: location.hash || "", query, params: location.params || {}, fullPath: getFullPath(location, stringifyQuery2), matched: record ? formatMatch(record) : [] };
	      if (redirectedFrom) {
	    ...
	    var View = { name: "RouterView", functional: true, props: { name: { type: String, default: "default" } }, render: function render(_, ref) {
	      var props = ref.props;
	    ...
	    function vue_router_parse(str, options) {
	      ...
	      while ((res = vue_router_PATH_REGEXP.exec(str)) != null) {
	        ...
	        tokens.push({ name: name || key++, prefix: prefix || "", delimiter, optional, repeat, partial, asterisk: !!asterisk, pattern: pattern ? vue_router_escapeGroup(pattern) : asterisk ? ".*" : "[^" + vue_router_escapeString(delimiter) + "]+?" });
	      }
	      if (index < str.length) {
	        path += str.substr(index);
	      }
	    ...
	    var Link = { name: "RouterLink", props: { to: { type: toTypes, required: true }, tag: { type: String, default: "a" }, custom: Boolean, exact: Boolean, exactPath: Boolean, append: Boolean, replace: Boolean, activeClass: String, exactActiveClass: String, ariaCurrentValue: { type: String, default: "page" }, event: { type: eventTypes, default: "click" } }, render: function render(h) {
	      ...
	      var scopedSlot = !this.$scopedSlots.$hasNormal && this.$scopedSlots.default && this.$scopedSlots.default({ href, route, navigate: handler, isActive: classes[activeClass], isExactActive: classes[exactActiveClass] });
	      if (scopedSlot) {
	    ...
	    function createMatcher(routes, router) {
	      ...
	      function redirect(record, location) {
	        ...
	        if (name) {
	          nameMap[name];
	          return match({ _normalized: true, name, query, hash, params }, void 0, location);
	        } else if (path) {
	          var rawPath = resolveRecordPath(path, record);
	          var resolvedPath = fillParams(rawPath, params);
	          return match({ _normalized: true, path: resolvedPath, query, hash }, void 0, location);
	        } else {
	          return _createRoute(null, location);
	        }
	      }
	      function alias(record, location, matchAs) {
	        ...
	        var aliasedMatch = match({ _normalized: true, path: aliasedPath });
	        if (aliasedMatch) {
	      ...
	      return { match, addRoute, getRoutes, addRoutes };
	    }
	    ...
	    function getElementPosition(el, offset) {
	      ...
	      return { x: elRect.left - docRect.left - offset.x, y: elRect.top - docRect.top - offset.y };
	    }
	    function isValidPosition(obj) {
	      return isNumber(obj.x) || isNumber(obj.y);
	    }
	    function normalizePosition(obj) {
	      return { x: isNumber(obj.x) ? obj.x : window.pageXOffset, y: isNumber(obj.y) ? obj.y : window.pageYOffset };
	    }
	    function normalizeOffset(obj) {
	      return { x: isNumber(obj.x) ? obj.x : 0, y: isNumber(obj.y) ? obj.y : 0 };
	    }
	    function isNumber(v) {
	    ...
	    var NavigationFailureType = { redirected: 2, aborted: 4, cancelled: 8, duplicated: 16 };
	    ...
	    var nuxt_child = { name: "NuxtChild", functional: true, props: { nuxtChildKey: { type: String, default: "" }, keepAlive: Boolean, keepAliveProps: { type: Object, default: void 0 } }, render(_, { parent, data, props }) {
	      ...
	      return h("transition", { props: transitionProps, on: listeners }, [routerView]);
	    } };
	    const transitionsKeys = ["name", "mode", "appear", "css", "type", "duration", "enterClass", "leaveClass", "appearClass", "enterActiveClass", "enterActiveClass", "leaveActiveClass", "appearActiveClass", "enterToClass", "leaveToClass", "appearToClass"];
	    const listenersKeys = ["beforeEnter", "enter", "afterEnter", "enterCancelled", "beforeLeave", "leave", "afterLeave", "leaveCancelled", "beforeAppear", "appear", "afterAppear", "appearCancelled"];
	    var errorvue_type_template_id_12a32de6_scoped_true_render = function render() {
	      var _vm = this, _c = _vm._self._c;
	      return _c("div", { staticClass: "error404" }, [_vm._ssrNode('<div class="container text-center" data-v-12a32de6><div class="error-image" data-v-12a32de6><img src="/img/page-404-image.png" alt="Not Found Image" class="img-fluid" data-v-12a32de6></div> ' + (_vm.error.statusCode === 404 ? '<h1 class="error-404-title text-white" data-v-12a32de6>Oops!, esta p\xE1gina no esta disponible!</h1>' : '<h1 class="error-404-title text-white" data-v-12a32de6>Oh! ha ocurrido un error</h1>') + ' <div class="error-buttons" data-v-12a32de6><button class="btn btn-primary btn-hover-dark" data-v-12a32de6><span class="button-text" data-v-12a32de6>Ir a la p\xE1gina anterior</span></button></div></div>')]);
	    };
	    var staticRenderFns = [];
	    var errorvue_type_script_lang_js_ = { props: ["error"] };
	    ...
	    var error_component = Object(componentNormalizer["a"])(
	      ...
	      errorvue_type_template_id_12a32de6_scoped_true_render,
	      staticRenderFns,
	      false,
	      injectStyles,
	      "12a32de6",
	    ...
	    var components_nuxt = { name: "Nuxt", components: { NuxtChild: nuxt_child, NuxtError: layouts_error }, props: { nuxtChildKey: { type: String, default: void 0 }, keepAlive: Boolean, keepAliveProps: { type: Object, default: void 0 }, name: { type: String, default: "default" } }, errorCaptured(error) {
	      ...
	      if (!this.nuxt.err) {
	        return h("NuxtChild", { key: this.routerViewKey, props: this.$props });
	      }
	      if (this.errorFromNuxtError) {
	        this.$nextTick(() => this.errorFromNuxtError = false);
	        return h("div", {}, [h("h2", "An error occurred while showing the error page"), h("p", "Unfortunately an error occurred and while showing the error page another error occurred"), h("p", `Error details: ${this.errorFromNuxtError.toString()}`), h("nuxt-link", { props: { to: "/" } }, "Go back to home")]);
	      }
	      this.displayingNuxtError = true;
	      this.$nextTick(() => this.displayingNuxtError = false);
	      return h(layouts_error, { props: { error: this.nuxt.err } });
	    } };
	    var nuxt_loadingvue_type_script_lang_js_ = { name: "NuxtLoading", data() {
	      return { percent: 0, show: false, canSucceed: true, reversed: false, skipTimerCount: 0, rtl: false, throttle: 200, duration: 5e3, continuous: false };
	    }, computed: { left() {
	      ...
	      let el = h(false);
	      if (this.show) {
	        el = h("div", { staticClass: "nuxt-progress", class: { "nuxt-progress-notransition": this.skipTimerCount > 0, "nuxt-progress-failed": !this.canSucceed }, style: { width: this.percent + "%", left: this.left } });
	      }
	      return el;
	    } };
	    ...
	    var defaultvue_type_template_id_74d94772_render = function render() {
	      var _vm = this, _c = _vm._self._c;
	      return _c("div", [_c("client-only", [_c("Nuxt")], 1), _vm._ssrNode(" "), _c("client-only", [_c("notifications", { attrs: { "position": "bottom left", "classes": "vue-notification success" } })], 1), _vm._ssrNode(" <button" + _vm._ssrClass("scroll-top", { "show": _vm.isVisible }) + '><i class="fa fa-angle-double-up"></i></button>')], 2);
	    };
	    var defaultvue_type_template_id_74d94772_staticRenderFns = [];
	    var defaultvue_type_script_lang_js_ = { name: "default", data() {
	    ...
	    var default_component = Object(componentNormalizer["a"])(
	      ...
	      defaultvue_type_template_id_74d94772_render,
	      defaultvue_type_template_id_74d94772_staticRenderFns,
	      false,
	      null,
	      null,
	      "3f414c95"
	    ...
	    var HomeSidebarMenuvue_type_template_id_d81b703a_render = function render() {
	      var _vm = this, _c = _vm._self._c;
	      return _c("div", { staticClass: "wrapper-five" }, [_c("HomeSidebarMenu"), _vm._ssrNode(" "), _c("Nuxt"), _vm._ssrNode(" "), _c("client-only", [_c("notifications", { attrs: { "position": "bottom left", "classes": "vue-notification success" } })], 1), _vm._ssrNode(" <button" + _vm._ssrClass("scroll-top", { "show": _vm.isVisible }) + '><i class="fa fa-angle-double-up"></i></button>')], 2);
	    };
	    var HomeSidebarMenuvue_type_template_id_d81b703a_staticRenderFns = [];
	    var HomeSidebarMenuvue_type_script_lang_js_ = { data() {
	      return { isVisible: false };
	    }, methods: { scrollToTop() {
	      window.scroll({ top: 0, behavior: "smooth" });
	    } }, mounted() {
	    ...
	    var layouts_HomeSidebarMenuvue_type_script_lang_js_ = HomeSidebarMenuvue_type_script_lang_js_;
	    var HomeSidebarMenu_component = Object(componentNormalizer["a"])(
	    ...
	    var App = { render(h, props) {
	      const loadingEl = h("NuxtLoading", { ref: "loading" });
	      const layoutEl = h(this.layout || "nuxt");
	      const templateEl = h("div", { domProps: { id: "__layout" }, key: this.layoutName }, [layoutEl]);
	      const transitionEl = h("transition", { props: { name: "layout", mode: "out-in" }, on: { beforeEnter(el) {
	        window.$nuxt.$nextTick(() => {
	          window.$nuxt.$emit("triggerScroll");
	        });
	      } } }, [templateEl]);
	      return h("div", { domProps: { id: "__nuxt" } }, [loadingEl, transitionEl]);
	    }, data: () => ({ isOnline: true, layout: null, layoutName: "", nbFetching: 0 }), beforeCreate() {
	    ...
	    }, watch: { "nuxt.err": "errorChanged" }, computed: { isOffline() {
	      return !this.isOnline;
	    }, isFetching() {
	      return this.nbFetching > 0;
	    } }, methods: { refreshOnlineStatus() {
	    }, async refresh() {
	    ...
	    } }, components: { NuxtLoading: nuxt_loading } };
	    vue_runtime["b"].use(vuex["a"]);
	    let store_store = {};
	    ...
	    const createStore = store_store instanceof Function ? store_store : () => {
	      return new vuex["a"].Store(Object.assign({ strict: false }, store_store));
	    };
	    ...
	    function wrapFunctional(options) {
	      ...
	      return { render(h) {
	        ...
	        return h(options, { on: this.$listeners, attrs, props, scopedSlots: this.$scopedSlots }, this.$slots.default);
	      } };
	    }
	    ...
	    var external_hookable_ = __webpack_require__(23);
	    ...
	    var app_plugin = async (ctx, inject) => {
	      const nuxtApp = { vueApp: { component: (id, definition) => runOnceWith(definition, () => vue_runtime["b"].component(id, definition)), config: { globalProperties: {} }, directive: (id, definition) => runOnceWith(definition, () => vue_runtime["b"].directive(id, definition)), mixin: (mixin) => runOnceWith(mixin, () => vue_runtime["b"].mixin(mixin)), mount: () => {
	      }, provide: inject, unmount: () => {
	      }, use(vuePlugin) {
	        runOnceWith(vuePlugin, () => vuePlugin.install(this));
	      }, version: vue_runtime["r"] }, provide: inject, globalName: "nuxt", payload: proxiedState(ctx.ssrContext.nuxt), _asyncDataPromises: [], isHydrating: true, nuxt2Context: ctx };
	      nuxtApp.hooks = Object(external_hookable_["createHooks"])();
	      nuxtApp.hook = nuxtApp.hooks.hook;
	      nuxtApp.callHook = nuxtApp.hooks.callHook;
	      const middleware = await Promise.resolve().then(__webpack_require__.bind(null, 7)).then((r) => r.default);
	      nuxtApp._middleware = nuxtApp._middleware || { global: [], named: middleware };
	      ...
	      const proxiedApp = new Proxy(nuxtApp, { get(target, prop) {
	        if (prop[0] === "$") {
	          var _target$vue2App;
	    ...
	    var config_plugin = (ctx) => {
	      ...
	      ctx.$config = new Proxy(config, { get(target, prop) {
	    ...
	    var nitro_bridge_server = defineNuxtPlugin((nuxtApp) => {
	      ...
	      nuxtApp.ssrContext.renderMeta = async () => {
	        const metadata = { htmlAttrs: "", headAttrs: "", headTags: "", bodyAttrs: "", bodyScriptsPrepend: "", bodyScripts: "" };
	    ...
	    var pwa_meta = __webpack_require__(26);
	    var meta_plugin = function({ app }) {
	      mergeMeta(app.head, pwa_meta);
	    };
	    var icon_plugin = async function(ctx, inject) {
	      const icons = { "64x64": "/_nuxt/icons/icon_64x64.1f8a4c.png", "120x120": "/_nuxt/icons/icon_120x120.1f8a4c.png", "144x144": "/_nuxt/icons/icon_144x144.1f8a4c.png", "152x152": "/_nuxt/icons/icon_152x152.1f8a4c.png", "192x192": "/_nuxt/icons/icon_192x192.1f8a4c.png", "384x384": "/_nuxt/icons/icon_384x384.1f8a4c.png", "512x512": "/_nuxt/icons/icon_512x512.1f8a4c.png", "ipad_1536x2048": "/_nuxt/icons/splash_ipad_1536x2048.1f8a4c.png", "ipadpro9_1536x2048": "/_nuxt/icons/splash_ipadpro9_1536x2048.1f8a4c.png", "ipadpro10_1668x2224": "/_nuxt/icons/splash_ipadpro10_1668x2224.1f8a4c.png", "ipadpro12_2048x2732": "/_nuxt/icons/splash_ipadpro12_2048x2732.1f8a4c.png", "iphonese_640x1136": "/_nuxt/icons/splash_iphonese_640x1136.1f8a4c.png", "iphone6_50x1334": "/_nuxt/icons/splash_iphone6_50x1334.1f8a4c.png", "iphoneplus_1080x1920": "/_nuxt/icons/splash_iphoneplus_1080x1920.1f8a4c.png", "iphonex_1125x2436": "/_nuxt/icons/splash_iphonex_1125x2436.1f8a4c.png", "iphonexr_828x1792": "/_nuxt/icons/splash_iphonexr_828x1792.1f8a4c.png", "iphonexsmax_1242x2688": "/_nuxt/icons/splash_iphonexsmax_1242x2688.1f8a4c.png" };
	    ...
	    var cookie_universal_nuxt = ({ req, res }, inject) => {
	      const options = { "alias": "cookies", "parseJSON": true };
	      inject(options.alias, external_cookie_universal_default()(req, res, options.parseJSON));
	    };
	    var external_axios_ = __webpack_require__(5);
	    var external_axios_default = /* @__PURE__ */ __webpack_require__.n(external_axios_);
	    function defu_isObject(val) {
	      return val !== null && typeof val === "object";
	    }
	    function defu_defu(baseObj, defaults, namespace = ".", merger) {
	      if (!defu_isObject(defaults)) {
	        return defu_defu(baseObj, {}, namespace, merger);
	      }
	      ...
	      for (const key in baseObj) {
	        ...
	        } else if (defu_isObject(val) && defu_isObject(obj[key])) {
	          obj[key] = defu_defu(val, obj[key], (namespace ? `${namespace}.` : "") + key.toString(), merger);
	        } else {
	          obj[key] = val;
	        }
	      }
	    ...
	    function defu_extend(merger) {
	      return (...args) => args.reduce((p, c) => defu_defu(p, c, "", merger), {});
	    }
	    const dist_defu_defu = defu_extend();
	    dist_defu_defu.fn = defu_extend((obj, key, currentValue, _namespace) => {
	      if (typeof obj[key] !== "undefined" && typeof currentValue === "function") {
	        obj[key] = currentValue(obj[key]);
	        return true;
	      }
	    });
	    dist_defu_defu.arrayFn = defu_extend((obj, key, currentValue, _namespace) => {
	      if (Array.isArray(obj[key]) && typeof currentValue === "function") {
	        obj[key] = currentValue(obj[key]);
	        return true;
	      }
	    });
	    dist_defu_defu.extend = defu_extend;
	    const axiosExtra = { setBaseURL(baseURL) {
	      ...
	      return createAxiosInstance(dist_defu_defu(options, this.defaults));
	    } };
	    ...
	    var _nuxt_axios = (ctx, inject) => {
	      ...
	      const baseURL = runtimeConfig.baseURL || runtimeConfig.baseUrl || process.env._AXIOS_BASE_URL_ || "https://api.trivicare.com";
	      const headers = { "common": { "Accept": "application/json, text/plain, */*" }, "delete": {}, "get": {}, "head": {}, "post": {}, "put": {}, "patch": {} };
	      const axiosOptions = { baseURL, headers };
	    ...
	    function dist_defu_isObject(value) {
	      return value !== null && typeof value === "object";
	    }
	    function defu_dist_defu_defu(baseObject, defaults, namespace = ".", merger) {
	      if (!dist_defu_isObject(defaults)) {
	        return defu_dist_defu_defu(baseObject, {}, namespace, merger);
	      }
	      ...
	      for (const key in baseObject) {
	        ...
	        } else if (dist_defu_isObject(value) && dist_defu_isObject(object[key])) {
	          object[key] = defu_dist_defu_defu(value, object[key], (namespace ? `${namespace}.` : "") + key.toString(), merger);
	        } else {
	          object[key] = value;
	        }
	      }
	    ...
	    function defu_createDefu(merger) {
	      return (...arguments_) => arguments_.reduce((p, c) => defu_dist_defu_defu(p, c, "", merger), {});
	    }
	    const node_modules_defu_dist_defu_defu = defu_createDefu();
	    ...
	    async function _imageMeta(url) {
	      {
	        const imageMeta2 = await Promise.resolve().then(__webpack_require__.t.bind(null, 75, 7)).then((r) => r.default || r);
	        ...
	        const meta = { width, height, ratio: width && height ? width / height : void 0 };
	        return meta;
	      }
	    }
	    function getCache(ctx) {
	      if (!ctx.nuxtContext.cache) {
	        if (ctx.nuxtContext.ssrContext && ctx.nuxtContext.ssrContext.cache) {
	          ...
	          const _cache = {};
	          ctx.nuxtContext.cache = { get: (id) => _cache[id], set: (id, value) => {
	            _cache[id] = value;
	    ...
	    function createImage(globalOptions, nuxtContext) {
	      const ctx = { options: globalOptions, nuxtContext };
	      ...
	      const $img = function $img2(input, modifiers = {}, options = {}) {
	        return getImage(input, { ...options, modifiers: node_modules_defu_dist_defu_defu(modifiers, options.modifiers || {}) }).url;
	      };
	    ...
	    function resolveImage(ctx, input, options) {
	      ...
	      const _options = node_modules_defu_dist_defu_defu(options, preset, defaults);
	    ...
	    function getSizes(ctx, input, opts) {
	      ...
	      for (const key in sizes) {
	        ...
	        variants.push({ width: _cWidth, size, screenMaxWidth, media: `(max-width: ${screenMaxWidth}px)`, src: ctx.$img(input, { ...opts.modifiers, width: _cWidth, height: _cHeight }, opts) });
	      }
	      ...
	      return { sizes: variants.map((v) => `${v.media ? v.media + " " : ""}${v.size}`).join(", "), srcset: variants.map((v) => `${v.src} ${v.width}w`).join(", "), src: defaultVar === null || defaultVar === void 0 ? void 0 : defaultVar.src };
	    }
	    var nuxt_imgvue_type_template_id_4c03b41d_render = function render() {
	      var _vm = this, _c = _vm._self._c; _vm._self._setupProxy;
	      return _c("img", _vm._g(_vm._b({ key: _vm.nSrc, ref: "img", attrs: { "src": _vm.nSrc } }, "img", _vm.nAttrs, false), _vm.$listeners), []);
	    };
	    var nuxt_imgvue_type_template_id_4c03b41d_staticRenderFns = [];
	    const defineMixin = (opts) => opts;
	    const imageMixin = defineMixin({ props: { src: { type: String, required: true }, format: { type: String, default: void 0 }, quality: { type: [Number, String], default: void 0 }, background: { type: String, default: void 0 }, fit: { type: String, default: void 0 }, modifiers: { type: Object, default: void 0 }, preset: { type: String, default: void 0 }, provider: { type: String, default: void 0 }, sizes: { type: [Object, String], default: void 0 }, preload: { type: Boolean, default: void 0 }, width: { type: [String, Number], default: void 0 }, height: { type: [String, Number], default: void 0 }, alt: { type: String, default: void 0 }, referrerpolicy: { type: String, default: void 0 }, usemap: { type: String, default: void 0 }, longdesc: { type: String, default: void 0 }, ismap: { type: Boolean, default: void 0 }, crossorigin: { type: [Boolean, String], default: void 0, validator: (val) => ["anonymous", "use-credentials", "", true, false].includes(val) }, loading: { type: String, default: void 0 }, decoding: { type: String, default: void 0, validator: (val) => ["async", "auto", "sync"].includes(val) } }, computed: { nImgAttrs() {
	      return { width: parseSize(this.width), height: parseSize(this.height), alt: this.alt, referrerpolicy: this.referrerpolicy, usemap: this.usemap, longdesc: this.longdesc, ismap: this.ismap, crossorigin: this.crossorigin === true ? "anonymous" : this.crossorigin || void 0, loading: this.loading, decoding: this.decoding };
	    }, nModifiers() {
	      return { ...this.modifiers, width: parseSize(this.width), height: parseSize(this.height), format: this.format, quality: this.quality, background: this.background, fit: this.fit };
	    }, nOptions() {
	      return { provider: this.provider, preset: this.preset };
	    } } });
	    const defineComponent = (opts) => opts;
	    var nuxt_imgvue_type_script_lang_js_ = defineComponent({ name: "NuxtImg", mixins: [imageMixin], props: { placeholder: { type: [Boolean, String, Number, Array], default: void 0 } }, head() {
	      if (this.preload === true) {
	        return { link: [{ rel: "preload", as: "image", href: this.nSrc }] };
	      }
	      return {};
	    }, computed: { nAttrs() {
	      ...
	      return this.$img.getSizes(this.src, { ...this.nOptions, sizes: this.sizes, modifiers: { ...this.nModifiers, width: parseSize(this.width), height: parseSize(this.height) } });
	    }, nSrc() {
	      ...
	      return this.$img(this.src, { ...this.nModifiers, width: size[0], height: size[1], quality: size[2] || 50 }, this.nOptions);
	    } }, mounted() {
	    ...
	    var nuxt_img_component = Object(componentNormalizer["a"])(
	    ...
	    var nuxt_picturevue_type_script_lang_js_ = nuxt_picturevue_type_script_lang_js_defineComponent({ name: "NuxtPicture", mixins: [imageMixin], props: { legacyFormat: { type: String, default: null }, imgAttrs: { type: Object, default: null } }, head() {
	      if (this.preload === true) {
	        const srcKey = typeof this.nSources[1] !== "undefined" ? 1 : 0;
	        const link = { rel: "preload", as: "image", imagesrcset: this.nSources[srcKey].srcset };
	      ...
	      const formats = { webp: this.isTransparent ? "png" : "jpeg", svg: "png" };
	      ...
	      const sources = formats.map((format) => {
	        const { srcset, sizes, src } = this.$img.getSizes(this.src, { ...this.nOptions, sizes: this.sizes || this.$img.options.screens, modifiers: { ...this.nModifiers, format } });
	    ...
	    var nuxt_picture_component = Object(componentNormalizer["a"])(
	    ...
	    const ipx_getImage = (src, { modifiers = {}, baseURL } = {}, ctx) => {
	      ...
	      return { url: Object(dist["f"])(baseURL, params, Object(dist["b"])(src)) };
	    };
	    const validateDomains = true;
	    const supportsAlias = true;
	    const static_getImage = (src, options, ctx) => ({ ...ipx_getImage(src, options, ctx), isStatic: true });
	    const static_supportsAlias = true;
	    const serverUrl = "https://api.trivicare.com/";
	    function custom_getImage(src, { modifiers = {}, baseURL = serverUrl }, { options, nuxtContext, $img }) {
	      const operations = [];
	      const operationsString = operations.join(",");
	      return { url: Object(dist["f"])(baseURL, operationsString, src) };
	    }
	    const imageOptions = { "screens": { "xs": 320, "sm": 640, "md": 768, "lg": 1024, "xl": 1280, "xxl": 1536, "2xl": 1536 }, "presets": {}, "provider": "ipx", "domains": [], "alias": {} };
	    imageOptions.providers = { ["static"]: { provider: static_namespaceObject, defaults: {} }, ["ipx"]: { provider: ipx_namespaceObject, defaults: {} }, ["customProvider"]: { provider: custom_namespaceObject, defaults: {} } };
	    vue_runtime["b"].component(nuxt_img.name, nuxt_img);
	    vue_runtime["b"].component(nuxt_picture.name, nuxt_picture);
	    vue_runtime["b"].component("NImg", nuxt_img);
	    vue_runtime["b"].component("NPicture", nuxt_picture);
	    ...
	    var fontawesome_svg_core_ = __webpack_require__(3);
	    function ownKeys(object, enumerableOnly) {
	      var keys = Object.keys(object);
	      if (Object.getOwnPropertySymbols) {
	        var symbols = Object.getOwnPropertySymbols(object);
	    ...
	    (function(module3) {
	      (function(global2) {
	        ...
	        var humps2 = { camelize, decamelize, pascalize, depascalize: decamelize, camelizeKeys: function(object, options) {
	        ...
	        if (module3.exports) {
	          module3.exports = humps2;
	        } else {
	          globalThis.humps = humps2;
	        }
	      })();
	    })(humps$1);
	    ...
	    function convert(h, element) {
	      ...
	      if (typeof element === "string") {
	        ...
	        return h(element.tag, _objectSpread2(_objectSpread2({ class: combineClassObjects(mixins.class, dClass), style: _objectSpread2(_objectSpread2({}, mixins.style), dStyle), attrs: _objectSpread2(_objectSpread2({}, mixins.attrs), dAttrs) }, remainingData), {}, { props }), children);
	      }
	    }
	    ...
	    function classList(props) {
	      var _classes;
	      var classes = (_classes = { "fa-spin": props.spin, "fa-spin-pulse": props.spinPulse, "fa-spin-reverse": props.spinReverse, "fa-pulse": props.pulse, "fa-beat": props.beat, "fa-fade": props.fade, "fa-flash": props.flash, "fa-fw": props.fixedWidth, "fa-border": props.border, "fa-li": props.listItem, "fa-inverse": props.inverse, "fa-flip": props.flip === true, "fa-flip-horizontal": props.flip === "horizontal" || props.flip === "both", "fa-flip-vertical": props.flip === "vertical" || props.flip === "both" }, _defineProperty(_classes, "fa-".concat(props.size), props.size !== null), _defineProperty(_classes, "fa-rotate-".concat(props.rotation), props.rotation !== null), _defineProperty(_classes, "fa-pull-".concat(props.pull), props.pull !== null), _defineProperty(_classes, "fa-swap-opacity", props.swapOpacity), _defineProperty(_classes, "fa-bounce", props.bounce), _defineProperty(_classes, "fa-shake", props.shake), _defineProperty(_classes, "fa-beat-fade", props.beatFade), _classes);
	    ...
	    function normalizeIconArgs(icon) {
	      ...
	      if (fontawesome_svg_core_["parse"].icon) {
	        return fontawesome_svg_core_["parse"].icon(icon);
	      }
	      if (icon === null) {
	        return null;
	      }
	    ...
	    var FontAwesomeIcon = { name: "FontAwesomeIcon", functional: true, props: { beat: { type: Boolean, default: false }, border: { type: Boolean, default: false }, fade: { type: Boolean, default: false }, fixedWidth: { type: Boolean, default: false }, flash: { type: Boolean, default: false }, flip: { type: [Boolean, String], default: false, validator: function validator(value) {
	      return [true, false, "horizontal", "vertical", "both"].indexOf(value) > -1;
	    } }, icon: { type: [Object, Array, String], required: true }, mask: { type: [Object, Array, String], default: null }, listItem: { type: Boolean, default: false }, pull: { type: String, default: null, validator: function validator(value) {
	      return ["right", "left"].indexOf(value) > -1;
	    } }, pulse: { type: Boolean, default: false }, rotation: { type: [String, Number], default: null, validator: function validator(value) {
	      return [90, 180, 270].indexOf(parseInt(value, 10)) > -1;
	    } }, swapOpacity: { type: Boolean, default: false }, size: { type: String, default: null, validator: function validator(value) {
	      return ["2xs", "xs", "sm", "lg", "xl", "2xl", "1x", "2x", "3x", "4x", "5x", "6x", "7x", "8x", "9x", "10x"].indexOf(value) > -1;
	    } }, spin: { type: Boolean, default: false }, spinPulse: { type: Boolean, default: false }, spinReverse: { type: Boolean, default: false }, transform: { type: [String, Object], default: null }, symbol: { type: [Boolean, String], default: false }, title: { type: String, default: null }, inverse: { type: Boolean, default: false }, bounce: { type: Boolean, default: false }, shake: { type: Boolean, default: false }, beatFade: { type: Boolean, default: false } }, render: function render(createElement, context) {
	      var props = context.props;
	      var iconArgs = props.icon, maskArgs = props.mask, symbol = props.symbol, title = props.title;
	      var icon$1 = normalizeIconArgs(iconArgs);
	      var classes = objectWithKey("classes", classList(props));
	      var transform = objectWithKey("transform", typeof props.transform === "string" ? fontawesome_svg_core_["parse"].transform(props.transform) : props.transform);
	      var mask = objectWithKey("mask", normalizeIconArgs(maskArgs));
	      var renderedIcon = Object(fontawesome_svg_core_["icon"])(icon$1, _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, classes), transform), mask), {}, { symbol, title }));
	      if (!renderedIcon) {
	    ...
	    var FontAwesomeLayers = { name: "FontAwesomeLayers", functional: true, props: { fixedWidth: { type: Boolean, default: false } }, render: function render(createElement, context) {
	      var familyPrefix = fontawesome_svg_core_["config"].familyPrefix;
	      var staticClass = context.data.staticClass;
	      var classes = ["".concat(familyPrefix, "-layers")].concat(_toConsumableArray(context.props.fixedWidth ? ["".concat(familyPrefix, "-fw")] : []));
	      return createElement("div", _objectSpread2(_objectSpread2({}, context.data), {}, { staticClass: addStaticClass(staticClass, classes) }), context.children);
	    } };
	    var FontAwesomeLayersText = { name: "FontAwesomeLayersText", functional: true, props: { value: { type: [String, Number], default: "" }, transform: { type: [String, Object], default: null }, counter: { type: Boolean, default: false }, position: { type: String, default: null, validator: function validator(value) {
	      ...
	      var transform = objectWithKey("transform", typeof props.transform === "string" ? fontawesome_svg_core_["parse"].transform(props.transform) : props.transform);
	      var renderedText = Object(fontawesome_svg_core_["text"])(props.value.toString(), _objectSpread2(_objectSpread2({}, transform), classes));
	    ...
	    var free_brands_svg_icons_ = __webpack_require__(13);
	    fontawesome_svg_core_["library"].add(free_brands_svg_icons_["faTiktok"], free_brands_svg_icons_["faFacebookF"], free_brands_svg_icons_["faInstagram"]);
	    fontawesome_svg_core_["config"].autoAddCss = false;
	    vue_runtime["b"].component("faIcon", FontAwesomeIcon);
	    vue_runtime["b"].component("faLayers", FontAwesomeLayers);
	    vue_runtime["b"].component("faLayersText", FontAwesomeLayersText);
	    var external_swiper_ = __webpack_require__(28);
	    ...
	    var DEFAULT_CLASSES = Object.freeze({ containerClass: "swiper-container", wrapperClass: "swiper-wrapper", slideClass: "swiper-slide" });
	    var ComponentEvents;
	    ...
	    ***************************************************************************** */
	    ...
	    var handleClickSlideEvent = function(swiper2, event, emit) {
	      var _a, _b, _c;
	      if (swiper2 && !swiper2.destroyed) {
	        var eventPath = ((_a = event.composedPath) === null || _a === void 0 ? void 0 : _a.call(event)) || event.path;
	        if ((event === null || event === void 0 ? void 0 : event.target) && eventPath) {
	          var slides_1 = Array.from(swiper2.slides);
	          var paths = Array.from(eventPath);
	          if (slides_1.includes(event.target) || paths.some(function(item) {
	            return slides_1.includes(item);
	          })) {
	            var clickedIndex = swiper2.clickedIndex;
	            var reallyIndex = Number((_c = (_b = swiper2.clickedSlide) === null || _b === void 0 ? void 0 : _b.dataset) === null || _c === void 0 ? void 0 : _c.swiperSlideIndex);
	    ...
	    var bindSwiperEvents = function(swiper2, emit) {
	      SWIPER_EVENTS.forEach(function(eventName) {
	        swiper2.on(eventName, function() {
	      ...
	      return {
	        bind: function(element, binding, vnode) {
	          ...
	          element.addEventListener("click", function(event) {
	            ...
	            var swiper2 = getSwiperInstance(element, binding, vnode);
	            handleClickSlideEvent(swiper2, event, emitEvent);
	          });
	        },
	        inserted: function(element, binding, vnode) {
	          ...
	          var swiper2 = vueContext === null || vueContext === void 0 ? void 0 : vueContext[instanceName];
	          if (!swiper2 || swiper2.destroyed) {
	            swiper2 = new SwiperClass(element, swiperOptions);
	            vueContext[instanceName] = swiper2;
	            bindSwiperEvents(swiper2, emitEvent);
	            emitEvent(ComponentEvents.Ready, swiper2);
	          }
	        },
	        componentUpdated: function(element, binding, vnode) {
	          ...
	          if (getBooleanValueByInput(autoUpdate)) {
	            ...
	            if (swiper2) {
	              ...
	              if (isLoop) {
	                (_b = (_a = swiper2) === null || _a === void 0 ? void 0 : _a.loopDestroy) === null || _b === void 0 ? void 0 : _b.call(_a);
	              }
	              (_c = swiper2 === null || swiper2 === void 0 ? void 0 : swiper2.update) === null || _c === void 0 ? void 0 : _c.call(swiper2);
	              (_e = (_d = swiper2.navigation) === null || _d === void 0 ? void 0 : _d.update) === null || _e === void 0 ? void 0 : _e.call(_d);
	              (_g = (_f = swiper2.pagination) === null || _f === void 0 ? void 0 : _f.render) === null || _g === void 0 ? void 0 : _g.call(_f);
	              (_j = (_h = swiper2.pagination) === null || _h === void 0 ? void 0 : _h.update) === null || _j === void 0 ? void 0 : _j.call(_h);
	              if (isLoop) {
	                (_l = (_k = swiper2) === null || _k === void 0 ? void 0 : _k.loopCreate) === null || _l === void 0 ? void 0 : _l.call(_k);
	                (_m = swiper2 === null || swiper2 === void 0 ? void 0 : swiper2.update) === null || _m === void 0 ? void 0 : _m.call(swiper2);
	              }
	            }
	          }
	        },
	        unbind: function(element, binding, vnode) {
	          ...
	          if (getBooleanValueByInput(autoDestroy)) {
	            ...
	            if (swiper2 && swiper2.initialized) {
	              (_a = swiper2 === null || swiper2 === void 0 ? void 0 : swiper2.destroy) === null || _a === void 0 ? void 0 : _a.call(swiper2, getBooleanValueByInput(getStandardisedOptionByAttrs(vnode, ComponentPropNames.DeleteInstanceOnDestroy)), getBooleanValueByInput(getStandardisedOptionByAttrs(vnode, ComponentPropNames.CleanupStylesOnDestroy)));
	            }
	          }
	        }
	      };
	    ...
	    function getSwiperComponent(SwiperClass) {
	      var _a;
	      return vue_runtime["b"].extend({
	        name: CoreNames.SwiperComponent,
	        props: (_a = {
	          defaultOptions: { type: Object, required: false, default: function() {
	            return {};
	          } },
	          options: { type: Object, required: false }
	        }, _a[ComponentPropNames.AutoUpdate] = { type: Boolean, default: true }, _a[ComponentPropNames.AutoDestroy] = { type: Boolean, default: true }, _a[ComponentPropNames.DeleteInstanceOnDestroy] = { type: Boolean, required: false, default: true }, _a[ComponentPropNames.CleanupStylesOnDestroy] = { type: Boolean, required: false, default: true }, _a),
	        data: function() {
	          var _a2;
	          return _a2 = {}, _a2[CoreNames.SwiperInstance] = null, _a2;
	        },
	        computed: { swiperInstance: { cache: false, set: function(swiper2) {
	          this[CoreNames.SwiperInstance] = swiper2;
	        }, get: function() {
	        ...
	        methods: {
	          ...
	          autoReLoopSwiper: function() {
	            ...
	            if (this.swiperInstance && this.swiperOptions.loop) {
	              var swiper2 = this.swiperInstance;
	              (_a2 = swiper2 === null || swiper2 === void 0 ? void 0 : swiper2.loopDestroy) === null || _a2 === void 0 ? void 0 : _a2.call(swiper2);
	              (_b = swiper2 === null || swiper2 === void 0 ? void 0 : swiper2.loopCreate) === null || _b === void 0 ? void 0 : _b.call(swiper2);
	            }
	          },
	    ...
	    var SwiperSlideComponent = vue_runtime["b"].extend({ name: CoreNames.SwiperSlideComponent, computed: { slideClass: function() {
	      ...
	      return createElement("div", { class: this.slideClass }, this.$slots.default);
	    } });
	    var getInstaller = function(SwiperClass) {
	      var install2 = function(Vue, globalOptions) {
	    ...
	    function exporter(SwiperClass) {
	      var _a;
	      return _a = { version: "4.1.1", install: getInstaller(SwiperClass), directive: getDirective(SwiperClass) }, _a[CoreNames.SwiperComponent] = getSwiperComponent(SwiperClass), _a[CoreNames.SwiperSlideComponent] = SwiperSlideComponent, _a;
	    }
	    var VueAwesomeSwiper = exporter(external_swiper_default.a);
	    VueAwesomeSwiper.version;
	    VueAwesomeSwiper.install;
	    VueAwesomeSwiper.directive;
	    VueAwesomeSwiper.Swiper;
	    VueAwesomeSwiper.SwiperSlide;
	    var vue_awesome_swiper_esm = VueAwesomeSwiper;
	    __webpack_require__(58);
	    vue_runtime["b"].use(vue_awesome_swiper_esm);
	    var main = __webpack_require__(29);
	    var main_default = /* @__PURE__ */ __webpack_require__.n(main);
	    vue_runtime["b"].component("pagination", main_default.a);
	    function vue_observe_visibility_esm_typeof(obj) {
	      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
	        vue_observe_visibility_esm_typeof = function(obj2) {
	          return typeof obj2;
	        };
	      } else {
	        vue_observe_visibility_esm_typeof = function(obj2) {
	      ...
	      return vue_observe_visibility_esm_typeof(obj);
	    }
	    ...
	    function vue_observe_visibility_esm_toConsumableArray(arr) {
	      return vue_observe_visibility_esm_arrayWithoutHoles(arr) || vue_observe_visibility_esm_iterableToArray(arr) || vue_observe_visibility_esm_nonIterableSpread();
	    }
	    function vue_observe_visibility_esm_arrayWithoutHoles(arr) {
	      if (Array.isArray(arr)) {
	    ...
	    function vue_observe_visibility_esm_iterableToArray(iter) {
	      if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]")
	        return Array.from(iter);
	    }
	    function vue_observe_visibility_esm_nonIterableSpread() {
	      throw new TypeError("Invalid attempt to spread non-iterable instance");
	    }
	    ...
	    function throttle(callback, delay) {
	      ...
	      var throttled = function throttled2(state) {
	        ...
	        if ((!timeout || state !== lastState) && leading) {
	          callback.apply(void 0, [state].concat(vue_observe_visibility_esm_toConsumableArray(currentArgs)));
	        }
	        lastState = state;
	    ...
	    function deepEqual(val1, val2) {
	      if (val1 === val2)
	        return true;
	      if (vue_observe_visibility_esm_typeof(val1) === "object") {
	        for (var key in val1) {
	    ...
	    var VisibilityState = /* @__PURE__ */ function() {
	      ...
	      _createClass(VisibilityState2, [{ key: "createObserver", value: function createObserver(options, vnode) {
	        var _this = this;
	        if (this.observer) {
	      ...
	      } }, { key: "destroyObserver", value: function destroyObserver() {
	        if (this.observer) {
	    ...
	    var ObserveVisibility = { bind, update, unbind };
	    ...
	    var vue_observe_visibility_esm = vue_observe_visibility_esm_plugin;
	    vue_runtime["b"].use(vue_observe_visibility_esm);
	    __webpack_require__(67);
	    var shapes = { circle: function circle(size) {
	    ...
	    var Progress$$1 = { render: function render() {
	    ...
	    }, staticRenderFns: [], name: "Progress", props: { counterClockwise: { type: Boolean, default: false }, fillDuration: { type: [String, Number], default: 1 }, height: { type: [String, Number], default: 0 }, hideBackground: { type: Boolean, default: false }, indeterminate: { type: Boolean, default: false }, progress: { type: Number, default: 0, validate: function validate(value) {
	      return value >= -1 && value <= 1;
	    } }, rotate: { type: Boolean, default: false }, rotationDuration: { type: [String, Number], default: 1 }, shape: { type: String, default: null }, size: { type: [String, Number], default: 100 }, staticPath: { type: Boolean, default: false }, width: { type: [String, Number], default: 0 } }, data: function data() {
	      return { dasharray: 0, dashoffset: 0, rotation: 0, animating: false };
	    }, computed: { cssClass: function cssClass() {
	      return { "indeterminate": this.indeterminate };
	      ...
	      if (this.shape) {
	        ...
	        return vue_progress_path_esm_globalOptions.defaultShape;
	      }
	    }, finalWidth: function finalWidth() {
	      return this.width || parseFloat(this.size) + 50;
	    }, style: function style2() {
	      return { width: this.finalWidth + "px", height: this.finalHeight + "px" };
	    }, svgStyle: function svgStyle() {
	      return {};
	    }, path: function path() {
	      var path2 = shapes[this.finalShape] || this.finalShape;
	      if (path2) {
	        if (typeof path2 === "function") {
	          path2 = path2(this.size);
	        }
	        return path2;
	      }
	    } }, watch: { indeterminate: { handler: function handler(value) {
	      if (value) {
	        this.startAnimation();
	      } else {
	        this.stopAnimation();
	      }
	    }, immediate: true }, path: { handler: function handler() {
	      var _this = this;
	      this.$nextTick(function() {
	        _this.dasharray = _this.$refs.path.getTotalLength();
	      });
	    }, immediate: true } }, methods: { frame: function frame(timestamp) {
	      var time = timestamp - this._animationLastFrame;
	      this._animationLastFrame = timestamp;
	      if (this.rotate) {
	        var direction = this.counterClockwise ? -1 : 1;
	        var d = time * 360 / (parseFloat(this.rotationDuration) * 1e3);
	      ...
	      if (!this.staticPath) {
	        ...
	        var _d = time * range / (parseFloat(this.fillDuration) * 1e3);
	    ...
	    var vue_progress_path_esm_globalOptions = {};
	    function registerComponents(Vue, prefix) {
	      Vue.component(prefix + "progress", Progress$$1);
	    }
	    var vue_progress_path_esm_plugin = {
	      version: "0.0.2",
	      install: function install2(Vue, options) {
	        vue_progress_path_esm_globalOptions = Object.assign({}, { installComponents: true, componentsPrefix: "loading-", defaultShape: "circle" }, options);
	        if (vue_progress_path_esm_globalOptions.installComponents) {
	          registerComponents(Vue, vue_progress_path_esm_globalOptions.componentsPrefix);
	        }
	      }
	    };
	    var vue_progress_path_esm_GlobalVue = null;
	    if (typeof commonjsGlobal !== "undefined") {
	      vue_progress_path_esm_GlobalVue = commonjsGlobal.Vue;
	    }
	    if (vue_progress_path_esm_GlobalVue) {
	      vue_progress_path_esm_GlobalVue.use(vue_progress_path_esm_plugin);
	    }
	    var vue_progress_path_esm = vue_progress_path_esm_plugin;
	    vue_runtime["b"].use(vue_progress_path_esm, {});
	    ...
	    class runtime_Storage {
	      ...
	      _initState() {
	        ...
	        if (this._useVuex) {
	          const storeModule = { namespaced: true, state: () => this.options.initialState, mutations: { SET(state, payload) {
	            vue_runtime["b"].set(state, payload.key, payload.value);
	          } } };
	          this.ctx.store.registerModule(this.options.vuex.namespace, storeModule, { preserveState: Boolean(this.ctx.store.state[this.options.vuex.namespace]) });
	    ...
	    class runtime_BaseScheme {
	      constructor($auth, ...options) {
	        this.$auth = $auth;
	        this.options = options.reduce((p, c) => dist_defu_defu(p, c), {});
	      }
	      get name() {
	        return this.options.name;
	      }
	    }
	    const DEFAULTS$4 = { name: "local", endpoints: { login: { url: "/api/auth/login", method: "post" }, logout: { url: "/api/auth/logout", method: "post" }, user: { url: "/api/auth/user", method: "get" } }, token: { property: "token", type: "Bearer", name: "Authorization", maxAge: 1800, global: true, required: true, prefix: "_token.", expirationPrefix: "_token_expiration." }, user: { property: "user", autoFetch: true }, clientId: false, grantType: false, scope: false };
	    class LocalScheme extends runtime_BaseScheme {
	      ...
	      check(checkStatus = false) {
	        const response = { valid: false, tokenExpired: false };
	    ...
	    const DEFAULTS = { name: "refresh", endpoints: { refresh: { url: "/api/auth/refresh", method: "post" } }, refreshToken: { property: "refresh_token", data: "refresh_token", maxAge: 60 * 60 * 24 * 30, required: true, tokenRequired: false, prefix: "_refresh_token.", expirationPrefix: "_refresh_token_expiration." }, autoLogout: false };
	    class RefreshScheme extends LocalScheme {
	      ...
	      check(checkStatus = false) {
	        const response = { valid: false, tokenExpired: false, refreshTokenExpired: false, isRefreshable: true };
	        const token = this.token.sync();
	      ...
	      mounted() {
	        return super.mounted({ tokenCallback: () => {
	      ...
	      refreshTokens() {
	        ...
	        const endpoint = { data: { client_id: void 0, grant_type: void 0 } };
	    ...
	    var auth = function(ctx, inject) {
	      const options = { "resetOnError": false, "ignoreExceptions": false, "scopeKey": "scope", "rewriteRedirects": true, "fullPathRedirect": false, "watchLoggedIn": true, "redirect": { "login": "/login", "logout": "/", "home": "/", "callback": "/login" }, "vuex": { "namespace": "auth" }, "cookie": { "prefix": "auth.", "options": { "path": "/" } }, "localStorage": { "prefix": "auth." }, "defaultStrategy": "laravelJWT" };
	      const $auth = new runtime_Auth(ctx, options);
	      $auth.registerStrategy("laravelJWT", new LaravelJWTScheme($auth, { "url": "https://api.trivicare.com", "endpoints": { "login": { "url": "https://api.trivicare.com/api/auth/login", "method": "post" }, "refresh": { "url": "https://api.trivicare.com/api/auth/refresh", "method": "post" }, "logout": { "url": "https://api.trivicare.com/api/auth/logout", "method": "post" }, "user": { "url": "https://api.trivicare.com/api/auth/me", "method": "get" }, "redirect": { "login": "/", "logout": "/login" } }, "token": { "property": "access_token", "maxAge": 3600 }, "refreshToken": { "property": false, "data": false, "maxAge": 1209600, "required": false, "tokenRequired": true }, "name": "laravelJWT", "user": { "property": false }, "clientId": false, "grantType": false }));
	      inject("auth", $auth);
	      ctx.$auth = $auth;
	    ...
	    vue_runtime["b"].component(vue_no_ssr_common_default.a.name, { ...vue_no_ssr_common_default.a, render(h, ctx) {
	    ...
	    Object.defineProperty(vue_runtime["b"].prototype, "$nuxt", { get() {
	      const globalNuxt = this.$root ? this.$root.$options.$nuxt : null;
	      return globalNuxt;
	    }, configurable: true });
	    vue_runtime["b"].use(vue_meta_common_default.a, { "keyName": "head", "attribute": "data-n-head", "ssrAttribute": "data-n-head-ssr", "tagIDKeyName": "hid" });
	    ...
	    async function createApp(ssrContext, config = {}) {
	      ...
	      const app = { head: { "title": "ADMIN TRIVICARE", "titleTemplate": "%s", "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "hid": "description", "name": "description", "content": "" }, { "name": "facebook-domain-verification", "content": "emkkxxxa870mac4z4xcfd060aqgj1f" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }], "style": [], "script": [] }, store, router, nuxt: { defaultTransition, transitions: [defaultTransition], setTransitions(transitions) {
	        ...
	        return transitions;
	      }, err: null, dateErr: null, error(err) {
	        err = err || null;
	      ...
	      function inject(key, value) {
	        ...
	        vue_runtime["b"].use(() => {
	          if (!Object.prototype.hasOwnProperty.call(vue_runtime["b"].prototype, key)) {
	            Object.defineProperty(vue_runtime["b"].prototype, key, { get() {
	    ...
	    var nuxt_link_server = { name: "NuxtLink", extends: vue_runtime["b"].component("RouterLink"), props: { prefetch: { type: Boolean, default: true }, noPrefetch: { type: Boolean, default: false } } };
	    ...
	    const noopApp = () => new vue_runtime["b"]({ render: (h) => h("div", { domProps: { id: "__nuxt" } }) });
	    const createNext = (ssrContext) => (opts) => {
	      ...
	      ssrContext.res.writeHead(opts.status, { Location: Object(dist["g"])(fullPath) });
	      ssrContext.res.end();
	    };
	    __webpack_exports__["default"] = async (ssrContext) => {
	      ...
	      try {
	        ...
	        app.context.error({ statusCode: validationError.statusCode || "500", message: validationError.message });
	        return renderErrorPage();
	      }
	      if (!isValid) {
