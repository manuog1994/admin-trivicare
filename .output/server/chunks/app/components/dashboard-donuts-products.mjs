...
var modules = dashboardDonutsProducts$1.modules = {
  172: function(module, __webpack_exports__, __webpack_require__) {
    ...
    var staticRenderFns = [];
    var DonutsProductsvue_type_script_lang_js_ = { name: "Donut", components: { [false]: () => __webpack_require__.e(21).then(__webpack_require__.t.bind(null, 150, 7)) }, data: function() {
