...
const responsiveMobileMenu = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  ids: ids,
  modules: modules,
  'default': responsiveMobileMenu$1
}, [responsiveMobileMenu$1]);

export { responsiveMobileMenu as r };
//# sourceMappingURL=responsive-mobile-menu.mjs.map
